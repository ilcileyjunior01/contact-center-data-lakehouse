...
SILVER_COLS = [
    "id_whatsapp", "id_cliente", "id_operador", "nr_telefone_mascarado",
    "dt_inicio", "dt_fim", "st_atendimento", "nr_duracao_segundos",
    "nr_duracao_minutos", "fl_atendimento_completo", "dt_cdc_evento",
    "op_cdc", "hash_registro", "dt_ingestao_silver", "ano", "mes", "dia",
]
